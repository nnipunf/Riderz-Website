  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#">RIDERZ</a>
  ...
  <div class="col-lg-6 col-md-6 col-12">
  <h2 class="display-4">We are the ANARCHY</h2>
  <p class="py-3">
  ...
  <a href="about.php" class="btn btn-success">Wanna know more</a>
    ...
    <div class="card" >
      ...
      <div class="card-body">
        <h4 class="card-title">Top Notch</h4>
  ...
  <div class="col-lg-4 col-md-4 col-12">
    ...
    <div class="col-lg-4 col-md-4 col-12">
    <img src="images/p6.jpg" class="img-fluid pb-4">
    </div>
    <div class="col-lg-4 col-md-4 col-12">
    <img src="images/p6.jpg" class="img-fluid pb-4">
    </div>
    ...
    <p class="p-3 bg-dark text-white text-center">nipun.ferdous@g.bracu.ac.bd</p>
    </footer>
